    ...
    function getTexto() {
        ...
        fetch('/scout/' + id)
            ...
            .then(response => {
                ...
                document.getElementById("spotify1").src = txt4;
    ...
    function getLink() {
        ...
        fetch('/redes/' + id)
            ...
            .then(response => {
                ...
                document.getElementsByTagName("iframe").src=txt;
